...
//
// A task here is a COMMITMENT: someone said they would do a specific thing.
...
const OWNERS = new Set(['nathan', 'them', 'mutual']);
...
CREATE TABLE IF NOT EXISTS tasks (
  ...
  owner TEXT NOT NULL DEFAULT 'nathan',    -- nathan | them | mutual
  title TEXT NOT NULL,
  description TEXT,
  deadline TEXT,

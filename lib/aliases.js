...
// crm-display-names.json. Those answer "what should the CRM CALL this person"
...
const fs = require('fs');
const { DISPLAY_NAMES } = require('./config');
...
function loadAliasFile(file = DISPLAY_NAMES) {
  let raw = {};
...
function buildIndex(contacts = [], file = DISPLAY_NAMES) {

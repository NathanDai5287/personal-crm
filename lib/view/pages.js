...
function Slip(cite) {
  ...
  // The dagger convention: the id/range is clutter, so it lives in the hover
  // title; provenance opens in a new tab.
  return h('a', { class: cls, href, title, target: '_blank', rel: 'noopener' }, '†');
}
...
function TaskSource(t) {
  return h('div', { class: 'tasksrc' },
    ...
    t.msgId ? [' · agreed in ', Slip({ a: t.rangeStart || t.msgId, b: t.rangeEnd || t.msgId, p: t.msgId })] : '',
...
function DraftCard(d) {
  return h('div', { class: 'draftcard' },
    ...
    h('div', { class: 'draft-m' },
      ...
      d.msgId ? [' · ', Slip({ a: d.rangeStart || d.msgId, b: d.rangeEnd || d.msgId, p: d.msgId })] : '',

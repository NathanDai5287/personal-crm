...
const LEGEND_JOBS = [
  ...
  ['ingest', 'Reads a person’s waiting messages into their profile, week by week, each claim citing a message.', 'calls the model', true, 'weekly'],
  ['compact', 'Shortens aged timeline messages into one dated line each, to keep profiles readable.', 'calls the model', true, 'after ingest'],
];
const LEGEND_WORDS = [

...
function EditForm(t) {
  return h('form', { method: 'post', action: '/tasks/edit', class: 'tedit' },
    ...
    h('label', {}, 'Deadline ', h('span', { class: 'hint' }, 'YYYY-MM-DD, or blank'),
      h('input', { class: 'fld tw', name: 'deadline', value: t.deadline || '', placeholder: '2026-09-01', maxlength: '20' })),
...
function TaskCard(t, editing, today) {
  ...
  return h('div', { class: `taskcard${done ? ' done' : ''}` },
    ...
    h('div', { class: 'taskbody' },
      h('div', { class: 'taskline' }, ImpMark(t.importance), h('span', { class: 'tasktitle' }, t.title)),
    ...
    h('div', { class: 'taskaside' },
      ...
      isEditing ? '' : h('a', { class: 'btn sm', href: `/tasks?edit=${t.id}` }, 'edit')));
}
...
function AddSlip() {
  return h('form', { method: 'post', action: '/tasks/add', class: 'slipform' },
    ...
    h('input', { class: 'fld tw', name: 'deadline', placeholder: 'due — YYYY-MM-DD', maxlength: '20' }),
    ImpSelect(2),
  ...
  const body = h('div', {},
    ...
    h('div', { class: 'plate' },
      h('div', {},
        ...
        h('h2', { style: 'font-size:20px;margin-top:4px' },
          h('span', { id: 'cActive' }, String(activeCount)), ' active · ',
          h('span', { id: 'cDone' }, String(doneCount)), ' done')),
      h('div', { class: 'counts' },
        h('div', {}, h('b', { id: 'cActiveChip' }, String(activeCount)), h('span', {}, 'active')),
        h('div', {}, h('b', {}, String(drafts.length)), h('span', {}, 'in-tray')))),
    h('div', { class: 'todo' },
      h('div', {},
        AddSlip(),
        active.length
  ...
  return h('div', {},
    ...
    h('div', { class: 'legend' },
      ...
      h('dl', { class: 'legend-words' },
        LEGEND_WORDS.map(([term, def]) => [h('dt', {}, term), h('dd', {}, def)]))));
}

...
const SPLIT_TOKENS = 150_000; // a SINGLE week above this gets sub-split by day
...
module.exports = {
  ...
  fmtLocal, dateKey,
  weekStart, nextWeekStart, dayStart, lastCompleteWeekStart, nextPacificDaily,
  estTokens, planChunks,
};

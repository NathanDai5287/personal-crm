...
// content-dedup in lib/archive.js (a message already present by sent_at+sender is
...
// emits the identical merge sequence as running it forward day by day — so the
// cron stays dumb (it just runs; the logic decides). Overridable per-run via env.
